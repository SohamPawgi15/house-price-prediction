...
class TestHousePricePreprocessor:
    ...
    def preprocessor(self):
        ...
        return HousePricePreprocessor(
            outlier_threshold=3.0, log_transform_features=["LotArea", "GrLivArea"], create_interactions=True
        )
    ...
    def test_feature_engineering(self, preprocessor, sample_data):
        ...
        # Verify calculations
        assert (
            result["TotalSF"].iloc[0]
            == sample_data["TotalBsmtSF"].iloc[0] + sample_data["1stFlrSF"].iloc[0] + sample_data["2ndFlrSF"].iloc[0]
        )
    ...
    def test_create_interactions(self, preprocessor, sample_data):
        ...
        sample_data["TotalBathrooms"] = (
            sample_data["FullBath"] + sample_data["HalfBath"] + sample_data["BsmtFullBath"] + sample_data["BsmtHalfBath"]
        )
